...
public class UIController : MonoBehaviour
{
    ...
    public int GetWeaponIndex(string weaponName)
    {
        ...
        if (lowerName.Contains("carrot") || lowerName.Contains("胡萝卜") || lowerName.Contains("corn"))
            return CARROT_INDEX;
        else if (lowerName.Contains("meat") || lowerName.Contains("肉") || lowerName.Contains("blaster"))
            return MEAT_INDEX;
        else if (lowerName.Contains("pepper") || lowerName.Contains("辣椒") || lowerName.Contains("vegetable"))
            return PEPPER_INDEX;
